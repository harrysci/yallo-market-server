...
const configuration_module_1 = require("../../../config/database/mysql/configuration.module");
const configuration_service_1 = require("../../../config/database/mysql/configuration.service");
    ...
    common_1.Module({
        imports: [
            typeorm_1.TypeOrmModule.forRootAsync({
                imports: [configuration_module_1.MysqlConfigModule],
                ...
                inject: [configuration_service_1.MysqlConfigService],
            }),
        ],
    })
